    ...
    <SectionContainer navName="contact">
      <div className="section_inner">
        <div className="cavani_tm_contact w-full h-auto clear-both float-left mb-[100px]">
          ...
          <div><br></br><p> feel free to contact me at my email for questions, look forward to meeting you!</p></div>
              ...
              <li className="mb-[30px] w-1/2 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
                  <img
                    ...
                    alt="image"
                  />
                  <span className="block">Fairfax, Virginia</span>
                </div>
              </li>
              <li className="mb-[30px] w-1/2 pl-[30px]">
                <div className="list_inner w-full h-auto clear-both float-left relative border-solid border-[rgba(0,0,0,.07)] border text-center py-[32px] px-[25px]">
                ...
                <div className="mapouter">
                  <div className="gmap_canvas">
                    <iframe
                      ...
                      height={355}
                      id="gmap_canvas"
                      src="https://maps.google.com/maps?q=2880%20%20Washington%20DC&t=&z=13&ie=UTF8&iwloc=&output=embed"
                      frameBorder={0}
                      scrolling="no"
                      marginHeight={0}
                      marginWidth={0}
